...
class Rectangle():
    def __init__(self):
        ...
        self.change_x = randint(0,20)
        self.change_y = randint(0,20)
        self.colors=(randint(0,125),randint(0,125),randint(0,125))
    def move(self):
...
class  Circle(Rectangle):
    def __init__(self):
        self.pos = randint(0, 100)
        self.radius = randint(0,200)
        self.change_pos = randint(0,30)
...
class Polygon(Rectangle):
    def __init__(self):
        self.A1 = randint(0, 300)
        self.A2 = randint(0, 400)
        self.B1 = randint(0, 500)
        self.B2 = randint(0, 600)
        self.C1 = randint(0, 700)
        self.C2 = randint(0, 800)
        self.colors = (randint(0,255),randint(0,255),randint(0,255))
    def draw2(self):
